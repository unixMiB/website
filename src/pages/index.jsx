      ...
      <section id="comeContattarci">
        ...
        <Container>
          <Row>
            ...
            <Col md>
              <a href="/mercatino/">
                <FontAwesomeIcon class="faicon" icon="shopping-basket" />
                <b>Mercatino</b>
              </a>
            </Col>
            ...
            <Col md>
              <a
                ...
                target="_blank"
              >
                <FontAwesomeIcon class="faicon" icon={['fab', 'facebook-f']} />
                <b>Facebook</b>
              </a>
            </Col>
            ...
            <Col md>
              <a
                ...
                target="_blank"
              >
                <FontAwesomeIcon class="faicon" icon={['fab', 'github-alt']} />
                <b>Github</b>
              </a>
            </Col>
          </Row>
